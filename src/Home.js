    ...
    return (
      <div className="Home mx-auto container-fluid mt-0">
        ...
        <div className="IntroSec container">
          ...
          <div className="my-5">
            <img className="mx-auto d-block" src={divider} alt="divider" />
          </div>
          ...
          <div className="introsec2 mx-auto my-5">
            ...
            <div className="mx-auto my-5 row">
              <div className="mx-auto col-md-4 col-sm-12">
                <img className="rounded-circle mx-auto d-block" src={pencil} alt="pencil_pic" />
              </div>
            ...
            <div className="mx-auto my-5 row">
              ...
              <div className="intropic2 mx-auto col-md-4 col-xs-12">
                <img className="reactpic rounded-circle mx-auto d-block" src={react} alt="react_pic" />
              </div>
            </div>
          ...
          <div className="introsec3 mx-auto my-5">
            ...
            <Link className="messagebtn mx-auto d-block btn btn-block" to="/Contact"><i className="far fa-envelope" /> Message me</Link>
